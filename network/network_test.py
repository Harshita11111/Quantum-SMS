...
try:
    from network.server import QSMSServer  # type: ignore
    from network.client import QSMSClient  # type: ignore
    from network.message_protocol import (  # type: ignore
    ...
    from network.message_protocol import Message, MessageHeader, MessageType
